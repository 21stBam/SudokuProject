...
public class SudokuView extends JFrame {
    ...
    private GameGridButton [][] gameGridButtons = new GameGridButton[9][9];
...
//    private int numberOf_9 = 9;
    ...
    ClickOutOfGameAreaPanel clickablePanel = new ClickOutOfGameAreaPanel();
